...
public class Bswabe {
    ...
    private static final Pattern NUMBER_SPLITTER = Pattern.compile("(\\d)+of(\\d)+");
     ...
     */
    public static BswabeCphKey encrypt(BswabePub pub, String policy) throws MalformedPolicyException, NoSuchAlgorithmException {
     ...
     */
    public static BswabeElementBoolean decrypt(BswabePub pub, BswabePrv prv,
    ...
    private static BswabePolicy parsePolicyPostfix(String s) throws MalformedPolicyException {
        ...
        for (String tok : toks) {
            ...
            if (!NUMBER_SPLITTER.matcher(tok).matches()) {
